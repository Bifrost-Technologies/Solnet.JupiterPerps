...
{
    public partial class InstantUpdateLimitOrderParams
    {
        ...
        public static int Deserialize(ReadOnlySpan<byte> _data, int initialOffset, out InstantUpdateLimitOrderParams result)
        {
            int offset = initialOffset;
            result = new InstantUpdateLimitOrderParams();
