...
namespace Solnet.JupiterPerps.Errors
{
    public enum PerpetualsErrorKind : uint
    {
            ...
            InvalidDovesOraclePrice = 6050U,
            InvalidRequestTime = 6051U,
            PositionUpdatedTooRecent = 6052U,
            LedgerTokenAccountDoesNotMatch = 6053U,
            InvalidTokenLedger = 6054U,
            OraclePriceDifferenceTooLarge = 6055U,
            InvalidOracleSigner = 6056U,
            InvalidOracleTimestamp = 6057U,
            InvalidMaxGlobalLongSize = 6058U,
            InvalidMaxGlobalShortSize = 6059U,
            BorrowsDisabled = 6060U,
            BorrowLimitsExceeded = 6061U,
            WithdrawExceedsMarginLimits = 6062U,
            CannotLiquidate = 6063U
